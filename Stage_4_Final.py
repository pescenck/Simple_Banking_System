    ...
    def account_menu(self, accepted_credit_card_number):
        while True:
            ...
            if self.menu_selection == '1':
                ...
                accepted_card_balance = self.get_balance_by_card_number(accepted_credit_card_number)[0]
                self.update_card_balance(income_amount + accepted_card_balance, accepted_credit_card_number)
                self.connection.commit()
                ...
                if transfer_credit_card_number != self.credit_card_number:
                    ...
                    accepted_credit_card_balance = self.get_balance_by_card_number(accepted_credit_card_number)[0]

                    if accepted_credit_card_balance - transfer_amount < 0:
                        ...
                        self.update_card_balance(accepted_credit_card_balance - transfer_amount,
                                                 accepted_credit_card_number)
                        self.connection.commit()
                        print("Success!""\n")

            elif self.menu_selection == '4':
                self.delete_card(accepted_credit_card_number)
                self.connection.commit()
